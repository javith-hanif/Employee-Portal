...
<table id="usersTable" class="display table table-bordered" style="width:100%">
    <thead>
        <tr>
            <th class="bg-success">Id</th>
            <th class="bg-success">Employee</th>
            <th class="bg-success">Skills</th>
            <th class="bg-success">Employee details</th>
            <th class="bg-success">role</th>
            <th class="bg-success">gender</th>
            <th class="bg-success">qualification</th>
            <th class="bg-success">phone</th>
            <th class="bg-success">computerskills</th>
            <th class="bg-success">experience</th>
            <th class="bg-success">otherskills</th>
